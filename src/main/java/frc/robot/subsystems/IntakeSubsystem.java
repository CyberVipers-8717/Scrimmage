...
//Set up motors
    ...
    private static final double lift1_kP = 0.0001;
    private static final double lift1_kI = 0;
    private static final double lift1_kD = 0.0001;
    ...
    public IntakeSubsystem(){
        ...
        m_lift1 = new SparkMax(1, MotorType.kBrushless);
        m_lift2 = new SparkMax(2, MotorType.kBrushless);
        m_intake = new SparkMax(3, MotorType.kBrushless);
        ...
        lift1Config.idleMode(IdleMode.kCoast);
        ...
        lift2Config.idleMode(IdleMode.kCoast);
        lift2Config.smartCurrentLimit(60);
